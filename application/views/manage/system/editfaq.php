...
<!-- Form validation -->
				...
				<form id="validate" class="form-horizontal" action="<?php echo base_url().'manage/faqUpdate' ?>" enctype="multipart/form-data" method="POST">
	                <fieldset>
	                    ...
	                    <div class="widget">
	                    	...
	                    	<div class="well row-fluid">
	                            ...
	                            <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="text" class="validate[required] span12" name="question" id="req" value="<?php echo $question; ?>"/>
                                ...
                                <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="text" class="validate[required] span12" name="answer" id="req" value="<?php echo $answer;?>"/>
	                                </div>
	                            </div>
